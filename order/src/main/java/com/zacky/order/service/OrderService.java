 ...
 */
package com.zacky.order.service;

import com.zacky.order.entity.Order;
import com.zacky.order.repository.OrderRepository;
import com.zacky.order.vo.Product;
import com.zacky.order.vo.ResponseTemplate;
...
@Autowired
    ...
    public void update(Long orderId,Integer jumlah,String tanggal, String status){
     ...
     public ResponseTemplate getOrderWithProductById(Long id){
         ...
         Product product = restTemplate.getForObject("http://localhost:9008/api/v1/product/" +order.getProductId(), Product.class);
